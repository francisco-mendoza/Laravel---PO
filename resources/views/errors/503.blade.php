...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">
        <br><br>
        {{--<div class="title_">En Mantención</div>--}}
        <div class="content_"><h2>ROSS <br><br>En Mantención</h2></div>
        <br><br><br><br>
    </div>
