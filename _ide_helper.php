...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model{
         ...
         * @static
         */
        public static function findBy($columnName, $value, $columns = array()){
            return App\Models\RossModel::findBy($columnName, $value);
        }
    ...
    class Toastr extends \Whossun\Toastr\Facades\Toastr{
        ...
        public static function message(){
            return \Whossun\Toastr\Toastr::message();
        }
        ...
        public static function add($type, $message, $title = null, $options = array()){
            \Whossun\Toastr\Toastr::add($type, $message, $title, $options);
        }
        ...
        public static function info($message, $title = null, $options = array()){
            \Whossun\Toastr\Toastr::info($message, $title, $options);
        }
        ...
        public static function success($message, $title = null, $options = array()){
            \Whossun\Toastr\Toastr::success($message, $title, $options);
        }
        ...
        public static function warning($message, $title = null, $options = array()){
            \Whossun\Toastr\Toastr::warning($message, $title, $options);
        }
        ...
        public static function error($message, $title = null, $options = array()){
            \Whossun\Toastr\Toastr::error($message, $title, $options);
        }
