/**
 * Created by anarela on 06-02-17.
 */
var theGrid = null;
$(document).ready(function(){

    $("#guardar").on("click",function(){
        $("#f_conditions").validator();
    });
            ...
            "columnDefs": [
                ...
                },
                {
                    "render": function (data, type, row) {
                        return '<a href="' + condiciones + '/' + row[0] + '">' + data + '</a>';
                    },
                    "targets": 1
                },
                {
                    "render": function (data, type, row) {
                        return '<a href="' + condiciones + '/' + row[0] + '/edit" ><i class="icon-pencil"></i></a>';
                    },
                    "targets": 2,
                    "orderable": false,
                    "visible": editar
